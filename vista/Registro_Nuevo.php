                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label for="name" class="control-label">Correo
                                                                    ...
                                                                    (*)</label>
                                                                <input type="text" class="required form-control"
                                                                    id="name" name="correo_institu">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="name" class="control-label">Correo
                                                                    Electronico Personal (*)</label>
                                                                <input type="text" class="required form-control"
                                                                    id="name" name="correo_personal">
                                                            </div>
                                                        </div>
                                                    </section>
                                                </div>
                                                        ...
                                                        <div class="form-row">
                                                            <div
                                                                ...
                                                                <button type="submit" name="cr" id="cr"
                                                                    class="btn btn-primary waves-effect waves-light btn-lg">Crear
                                                                    Cuenta</button>
                                                            </div>
                                                        </div>
                                                    </section>
